...
CoreElementInit.prototype.each = function (func) { var cnt=0; var ele_cnt=this.element; var prnt_chld=this.parent_child; var ass_elem=assignElementDistinction(this.element, prnt_chld, {});
...
function getDomAttr (meth, d) { var attr_type=_stk.getTypeof(d)=="array"
        ?d
        :[d]; var globl={};
...
function getElementExistAttr (res) { var attr_elem={};
...
function domGetCSS (ele, prop) {
    ...
    this.loopstyle=function (dom, style, intt) { var golb={}; var golb_st="";
...
function domCSS (id, d) { var elem_str_class=""; var get_attr=_stk.has(getDomAttr(id, ['style']).style)
        ?getDomAttr(id, ['style']).style
        :""; var split_style=get_attr.toString().split(";");

    _stk.each(split_style, function (spk, spv) { var elem_d=spv.split(":");

        if (_stk.count(elem_d)>0 && _stk.has(spv)) {

            if (!_stk.has(d, elem_d[0]) && _stk.has(elem_d[1])) { var ele_key=elem_d[0].replace(/\s/, ""); var ele_val=elem_d[1].replace(/\s/, "");
    ...
    if (_stk.has(id)) {
        ...
        try {
            ...
            if (_stk.has(id.setAttributeNode)) { var creat_elem=document.createAttribute("style");
...
function domSelectOption (main, bol, type) { var opt; var sel_opt=''; var sel_opt_ar=[]; var opt_cnt=0; var select_count=0; var booln=bol||false;
...
function formGetValues (self) { var list_elem = [
        "input",
        "select",
        "textarea"
    ]; var ret_value = [];
        ...
        for ( var key in list_elem) {
            ...
            if (list_elem[key] == "select") {
                ...
                dom(html_form).findElem(list_elem[key])
                    .each(function (k, v) { var get_attr = dom(k).attr();
...
function domIOtype (type, dom, htmll) { var main_dom=null;

    if ((/\b(val)\b/g).test(type)) { var alt_val=this.get_attr(dom, "ps_alt_value");
...
function parentchild (child_prnt, de, cnt) {
    ...
    } else if (child_prnt==="odd" || child_prnt==="even") { var sel={
            "even": 0,
            "odd": 1
        };
 ...
 * // => {'as':2}
 */
function getDomAttr (meth, domValue) { var attr_type=_stk.getTypeof(domValue)==="array"
        ?domValue
        :[domValue]; var globl={};
...
function attr (d,bol){ var core = new CoreElementInit(this);
 ...
 */
function css (value, countValue) { var core = new CoreElementInit(this); var typeofs = _stk.getTypeof(value) === "json"; var cntt=_stk.has(countValue) === false
        ?0
        :countValue-1; var val_g = {};
 ...
 * // => ElementTrigger{element: Array(1), parent_child: null}element: Array(1)0: div#idlength: 1__proto__: Array(0)parent_child: null__proto__: Object
 */
function each (func) { var core = new CoreElementInit(this);
 ...
 * // => 1
 */
function getLength () { var core = new CoreElementInit(this); var cnt_i=0;
 ...
 * // => ElementTrigger{element: Array(1), parent_child: null}element: Array(1)0: div#idlength: 1__proto__: Array(0)parent_child: null__proto__: Object
 */
function getDom () { var core = new CoreElementInit(this); var id_dm=[];
 ...
 * // => ElementTrigger{element: Array(1), parent_child: null}element: Array(1)0: div#idlength: 1__proto__: Array(0)parent_child: null__proto__: Object
 */
function getIndexAttr (attr) { var core = new CoreElementInit(this); var cnt=0; var globl=[];
    ...
    core.each(function (meth) { var get_attr=getDomAttr(meth,getkey); var where_count=_stk.where(get_attr,attr);
 ...
 * // => null
 */
function show () { var core = new CoreElementInit(this);
 ...
 * // => null
 */
function hide () { var core = new CoreElementInit(this);
 ...
 * // => ElementTrigger{element: Array(1), parent_child: null}element: Array(1)0: div#idlength: 1__proto__: Array(0)parent_child: null__proto__: Object
 */
function removeAttr (value) { var core = new CoreElementInit(this); var attr_type = _stk.getTypeof(value) === "array"
        ?value
        :new Array(value);
 ...
 * // => BODY
 */
function tagName () { var core = new CoreElementInit(this); var arry_pl=[];
 ...
 * // => ElementTrigger{element: Array(1), parent_child: null}element: Array(1)0: div#idlength: 1__proto__: Array(0)parent_child: null__proto__: Object
 */
function findElem (elem) { var core = new CoreElementInit(this);
 ...
 * // => ElementTrigger{element: Array(1), parent_child: null}element: Array(1)0: div#idlength: 1__proto__: Array(0)parent_child: null__proto__: Object
 */
function getSelected (bol) { var core = new CoreElementInit(this);
 ...
 * // => ElementTrigger{element: Array(1), parent_child: null}element: Array(1)0: div#idlength: 1__proto__: Array(0)parent_child: null__proto__: Object
 */
function getFormAttr () { var core = new CoreElementInit(this);
 ...
 * // => ElementTrigger{element: Array(1), parent_child: null}element: Array(1)0: div#idlength: 1__proto__: Array(0)parent_child: null__proto__: Object
 */
function getSelectedCount (bol) { var core = new CoreElementInit(this);
 ...
 * // => ElementTrigger{element: Array(1), parent_child: null}element: Array(1)0: div#idlength: 1__proto__: Array(0)parent_child: null__proto__: Object
 */
function getSelectedText (bol) { var core = new CoreElementInit(this);
 ...
 * // => null
 */
function setSelected (val) { var core = new CoreElementInit(this); var opt = null;
 ...
 * // => ElementTrigger{element: Array(1), parent_child: null}element: Array(1)0: div#idlength: 1__proto__: Array(0)parent_child: null__proto__: Object
 */
function toggleDisplay (display) { var d_var=display||""; var core = new CoreElementInit(this);

    core.each(function (meth) { var elem=meth.style.display||domGetCSS(meth, "display");
 ...
 * // => ElementTrigger{element: Array(1), parent_child: null}element: Array(1)0: div#idlength: 1__proto__: Array(0)parent_child: null__proto__: Object
 */
function getParent () { var core = new CoreElementInit(this); var arry_pl=[];
 ...
 * // => 1
 */
function insertHtml (com, htm) { var lst_adj={
        "after": "afterend",
 ...
 * // => 1
 */
function index (doms) { var core = new CoreElementInit(this); var arry_dm = [];
 ...
 * // => false
 */
function isDomNull () { var core = new CoreElementInit(this); var bool=false;
 ...
 * // => 1
 */
function getChildPosition () { var core = new CoreElementInit(this); var incrementi = 1; var node=_stk.has(core.element[0])===false
        ?core.element
        :core.element[0];
 ...
 * // => ElementTrigger{element: Array(1), parent_child: null}element: Array(1)0: div#idlength: 1__proto__: Array(0)parent_child: null__proto__: Object
 */
function domView (dom, htm) { var core = new CoreElementInit(this); var domee=this.getLength(); var str=domee>1
        ?[]
        :"";

    core.each(function (meth) { var dom_type = _stk.indexOf([
            "checkbox",
            "radio"
...
function eventListener (elthis, c1, c2, c3, func, act_bool) { var var_elthis = elthis;
 ...
 * // => {'as':2}
 */
function assignElementDistinction (dom, assn, bools) { var assn_splt=_stk.ifUndefined(assn, "").split("::"); var glb=bools;
    ...
    if (assn_splt.length===1) {
    ...
    } else if (assn_splt.length==2) { var spl2=assn_splt[1]; var fltr=[
            "first",
            "haschild",
            "hasChildNodes",
            "last",
        ...
        for ( var td1 in dom) {
            ...
            if ((/([\w\-\_]{1,})(\(\d\))/g).test(spl2)) { var replc=spl2.replace(/([\w\-\_]{1,})\((\d)\)/g, function (g, g1, g2) {
 ...
 * // => {'as':2}
 */
function findElement (tar_m_sub, ar, bool) { var tar_m_split=tar_m_sub.split("=>"); var tar_m=(tar_m_split.length==0
        ?tar_m_sub
        :tar_m_split[0]).trim();
    ...
    for ( var ni in node) {
       ...
       if ((/\[/g).test(tar[ti])) {
                ...
                var fl_va_cntnt={};
                var fl_va_cntnt_all=[];
                var fl_va_attr_all=[]; var replc_str=tar[ti].replace(/([a-zA-Z\-\_]{0,}|\*)\[([\w\s\d\=\_\-\[\]\'\"\;\:]{1,})\]/gm, function (m, m1, m2, m3) { var m2_split_count=m2.split(";");

               _stk.each(m2_split_count, function (sck, scv) { var m2_split_cnt=scv.split("=");
               ...
               return "asd";
                ...
                if (_stk.has(node[ni].getElementsByTagName(fl_m_tot))) { var node_elem=node[ni].getElementsByTagName(fl_m_tot);
               ...
               for (var i=0, j=node_elem.length; i<j; i++) {
                       ...
                       if (_stk.count(fl_va_cntnt)>0 || _stk.count(fl_va_cntnt_all)>0 || _stk.count(fl_va_attr_all)>0) {
                                ...
                                if (_stk.count(fl_va_cntnt_all)>0) { var get_attr_key=_stk.getKey(get_attr);
            ...
            } else if ((/#/g).test(tar[ti])) { var replce_dom=tar[ti].toString().replace(/^[#]/g, ""); var idd_m=document.getElementById(replce_dom);
           ...
           if (_stk.has(idd_m)) {
       ...
       } else if ((/([a-zA-Z\-\_]{0,}\.[a-zA-Z0-9_\-]{1,})/g).test(tar[ti])) { var s_node =document; var match_dom=tar[ti].toString().match(/([a-zA-Z\-\_]{0,}\.[a-zA-Z0-9_\-]{1,})/g, "");
               ...
               for (var i=0, j=els.length; i<j; i++) { var class_name_string = els[i].className;
			 ...
			 m = (""+class_name_string).match(r); var var_return = !!m;
...
for ( var f1 in elementConfig.eventListener) {
    ...
    if (_stk.has(elementConfig.eventListener[f1])) { var check_mobile=(/(touchstart|touchmove|touchend)/).test(elementConfig.eventListener[f1])
...
PsExtender.prototype.extend={
    ...
    "obj_extnd" (id) { var ps_ob=new ElementTrigger(id);
...
PsExtender.prototype.dom={
    ...
    "html": {
        "hasClass" : function(str, klass) { var r = new RegExp("(?:^| )(" + klass + ")(?: |$)"),
                m = (""+str).match(r);
        ...
        "tag_value" : function(tar, ar) { var tar_sub=tar.split("=>");
    ...
    "init" : function(str, ar) { var ar_s=[]; var chd_dom=str.toString().match(/^[#.\w]{0,1}/g);
 ...
 * null
 */
function documentReady (func) { var root = window; var dom_rdy_ctt=0;
    ...
    } var fails=false; var dom_load_ready =function () {
    ...
    return null;
...
} var domCoreAssign=(function () { var doc_set=function (idss) { var domm=[]; var ps_ext=new PsExtender();
        ...
        try {
            ...
            } else { var doc_loop=idss.toString().split(",");
 ...
 * @since 2.0.1
 * @category DOM
 * @param {String} name The second number in an addition.
 ...
 * // => ElementTrigger{element: Array(1), parent_child: null}element: Array(1)0: div#idlength: 1__proto__: Array(0)parent_child: null__proto__: Object
 */
function extension (name, bascConfig) {
